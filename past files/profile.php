...
if ($userDetails !== false && !empty($userDetails)) {
    ...
    $_SESSION['personal_details'] = array('name' => 'Guest', 'role_name' => '', 'role_name' => '', 'role_id' => '');
...
// Initialize database and CoachingSystem (if not already done)
...
// Check for errors
$hasSessionErrors = isset($availedSessions['error']);
...
<section class="main-content vh-100">
    <div id="availed_services">
        ...
        <div class="availed-sessions-section">
            <h4>Your Coaching Sessions</h4>
            <?php if ($hasSessionErrors): ?>
                <div class="alert alert-danger" role="alert">
                    <i class="fas fa-exclamation-triangle"></i> There was an error fetching session data.
                </div>
