...
$adminPages = ['dashboard', 'members', 'members_new', 'add_member', 'renew_member', 'attendance', 'member_status', 'walk_in', 'gym_rates', 'programs', 'rentals', 'payment_records', 'notification', 'accounts', 'announcement', 'transactions', 'website_settings', 'content_management', 'report', 'staff_management', 'activity_logs'];
$staffPages = ['dashboard', 'members', 'members_new', 'add_member', 'renew_member', 'attendance', 'member_status', 'walk_in', 'gym_rates', 'programs', 'rentals', 'payment_records', 'notification', 'accounts', 'announcement', 'transactions',  'website_settings', 'content_management', 'report', 'activity_logs'];
