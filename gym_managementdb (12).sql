...
(1, 'welcome', 'Xiao Long Bai need\'s help', 'Unlock your full potential with our seamless gym membership system. Easily manage your membership, book sessions, and track your progress—all in one place. Join us today and take the first step toward a healthier, stronger you!\"', NULL, NULL, NULL),
(2, 'offers', 'Gym Offers', 'Get the best deals on memberships, personal training, and class packages. Whether you\'re a beginner or a seasoned athlete, we have flexible plans tailored to your fitness goals. Sign up today and enjoy special discounts, perks, and more!', NULL, NULL, NULL),
...
ALTER TABLE `coach_group_schedule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `coach_program_type_id` (`coach_program_type_id`);
...
--
ALTER TABLE `coach_group_schedule`
  ADD CONSTRAINT `coach_group_schedule_ibfk_1` FOREIGN KEY (`coach_program_type_id`) REFERENCES `coach_program_types` (`id`);

--
-- Constraints for table `coach_personal_schedule`
--
ALTER TABLE `coach_personal_schedule`
  ADD CONSTRAINT `coach_personal_schedule_ibfk_1` FOREIGN KEY (`coach_program_type_id`) REFERENCES `coach_program_types` (`id`);
...
--
ALTER TABLE `program_subscriptions`
  ADD CONSTRAINT `program_subscriptions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `program_subscriptions_ibfk_2` FOREIGN KEY (`coach_program_type_id`) REFERENCES `coach_program_types` (`id`);
