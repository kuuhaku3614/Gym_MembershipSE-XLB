...
<div class="modal fade" id="previewReportModal" tabindex="-1" aria-labelledby="previewReportModalLabel" aria-hidden="true">
    ...
    $(document).ready(function() {
     ...
     // Replace the original export button click handler
    ...
    // Replace your current Export as PDF button handler with this:
$('#export_pdf_btn').on('click', function() {
    ...
    // Add export_pdf field to the form
    ...
    // Submit the form directly (it will trigger the PHP PDF generation)
    form.submit();
    
    // Remove the extra input we added
